...
import cn.kiko.springframework.aop.framework.ReflectiveMethodInvocation;
import cn.kiko.springframework.aop.framework.adapter.MethodBeforeAdviceInterceptor;
...
import cn.kiko.test.aop.UserServiceBeforeAdvice;
...
public class ApiTest {
    ...
    public void test_advisor() {
        ...
        advisor.setExpression("execution(* cn.kiko.test.aop.IUserService.*(..))");
    ...
    public void test_proxy_method() {
        ...
        IUserService proxy = (IUserService) Proxy.newProxyInstance(Thread.currentThread().getContextClassLoader(), targetObj.getClass().getInterfaces(), new InvocationHandler() {
            // 方法匹配器
            MethodMatcher methodMatcher = new AspectJExpressionPointcut("execution(* cn.kiko.test.aop.IUserService.*(..))");
